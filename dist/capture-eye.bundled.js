    ...
    `}renderBottom(){const t=this.isOriginal()?`${pt.profile}/${this.nid}`:this.usedBy;return R`
      <div class="section">
        ...
        <div class="powered-by">
          ${this.usedBy!==mt.loading?"Powered by Numbers Protocol":R`<div class="shimmer-text"></div>`}
        </div>
      </div>
