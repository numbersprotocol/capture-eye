...
let CaptureEye = class CaptureEye extends LitElement {
    ...
    constructor() {
        ...
        this.assetDataFetched = false;
        this.assetDataNotFound = false;
        this.imageError = false;
        this.apiBaseUrl = 'https://eognt1jfpe04mq8.m.pipedream.net';
        this.ipfsGatewayBaseUrl = 'https://ipfs-pin.numbersprotocol.io/ipfs';
        this.explorerBaseUrl = 'https://mainnet.num.network';
        this.profileBaseUrl = 'https://nftsearch.site/asset-profile?nid=';
        this.captureEyeIcon = `${this.ipfsGatewayBaseUrl}/bafkreicf4sruldnh4g3bmxnqr6zjgfzfgvbqoa5iy2jncewqqlgg75utd4`;
        this.closeIcon = 'https://c.animaapp.com/twFYQx58/img/close@2x.png';
        this.contentCopyIcon = 'https://c.animaapp.com/twFYQx58/img/content-copy@2x.png';
        this.helpIcon = 'https://c.animaapp.com/twFYQx58/img/help-2@2x.png';
        /*
    ...
    tooltipTemplate(label, helpText) {
      ...
      <div class="icon-container">
        <img
          class="img"
          src=${this.helpIcon}
          @mouseover=${(e) => this.showTooltip(e, label)}
          @mouseleave=${(e) => this.hideTooltip(e, label)}
        />
    ...
    async fetchAssetData() {
        ...
        const response = await fetch(`${this.apiBaseUrl}?nid=${this.nid}`, {
            method: 'GET',
            headers,
        });
        if (response.ok) {
            ...
            console.log(`Error ${response.status}: ${await response
                .json()
                .then((r) => r.message)}`);
            this.showPanel = false;
...
], CaptureEye.prototype, "showPanel", void 0);
__decorate([
    property({ type: Boolean })
...
__decorate([
    property()
], CaptureEye.prototype, "capture_token", void 0);
__decorate([
    property({ attribute: false })
], CaptureEye.prototype, "metadata", void 0);
__decorate([
    property({ attribute: false })
], CaptureEye.prototype, "tooltipStates", void 0);
__decorate([
    property({ attribute: false })
], CaptureEye.prototype, "assetDataFetched", void 0);
__decorate([
    property({ attribute: false })
], CaptureEye.prototype, "assetDataNotFound", void 0);
__decorate([
    property({ attribute: false })
], CaptureEye.prototype, "imageError", void 0);
